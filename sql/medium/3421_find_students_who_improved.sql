...
SELECT t.student_id, t.subject, MIN(t.first_score) AS first_score, MAX(t.latest_score) AS latest_score FROM (
...
GROUP BY t.student_id, t.subject HAVING MIN(t.first_score) < MAX(t.latest_score)